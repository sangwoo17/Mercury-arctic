...
function c_dot = Unit_WorM3_ODE_Arctic2(t,c,A,V,D,M,R,Co,L,CS,CAO_t,V_set,F_Hg2,k,H,k_w,Hg_air,ice,Cw,Dw,Diff_d)
...
c_dot(1,1) = (1/V)*(- S0_Hg0toHgII + S0_HgIItoHg0 + M(1) -CS(1)- CAO_Hg0 -AS - Diff_Hg0);
